...
const Sidebar = () => {
    return (
        <section className="sidebar">
            ...
            <NavLink className={({ isActive }) => isActive ? 'nav-item active-link' : 'nav-item'} to="/completed"><FontAwesomeIcon icon={faCalendar} /><p className="navlink-text">Completed Tasks</p></NavLink>
